...
function registerIpcHandlers() {
  ...
  ipcMain.handle('update-repository', async (_event, id: string, updates: Partial<Pick<Repository, 'name' | 'defaultBranch' | 'remoteUrl' | 'purpose' | 'completionCriteria' | 'protectedBranches'>>) => {
